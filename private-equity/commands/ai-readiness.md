...
Load the `ai-readiness` skill and scan portfolio companies for AI leverage — per-company go/wait gate, quick wins ranked by EBITDA impact across the portfolio, and replays that hit multiple companies at once.
